...
<body
    class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    ...
    <main>
        <h1 class="text-white text-4xl mb-50 lg:mb-80"> My Secure Auth System</h1>
    </main>
...
<footer>
   <p class="text-white text-lg "> Built with ❤ by Adeola Olagbenro</p>
</footer>
